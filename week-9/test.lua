...
test.operations = function()
  test.equal(lang.execute("function main() { return 1 + 1 }"), 2)
  test.equal(lang.execute("function main() { return 1 + 1 + 123 }"), 125)
  test.equal(lang.execute("function main() { return 1 + 1 - 123 }"), -121)
  test.equal(lang.execute("function main() { return 12*12 - 123 }"), 21)
  test.equal(lang.execute("function main() { return 144/12 - 11 }"), 1)
  test.equal(lang.execute("function main() { return 17%7 }"), 3)
  test.equal(lang.execute("function main() { return 1 + 2*3 + 3*2^3 }"), 31)
end
